  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        '@type': 'WebApplication',
        name: 'Goal Tracker',
        url: 'https://bookchaowalit-goal-tracker.vercel.app',
        description: 'Goal Tracker by Bookchaowalit - A modern web application',
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://bookchaowalit-goal-tracker.vercel.app/more-projects',
